/*global history */
sap.ui.define([
		"nttdata/com/approval/controller/BaseController",
		"sap/ui/model/json/JSONModel",
		"sap/ui/model/Filter",
		"sap/ui/model/FilterOperator",
		"sap/m/GroupHeaderListItem",
		"sap/ui/Device",
		"nttdata/com/approval/model/formatter",
		"nttdata/com/approval/model/grouper",
		"nttdata/com/approval/model/GroupSortState"
	], function (BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, grouper, GroupSortState) {
		"use strict";

		return BaseController.extend("nttdata.com.approval.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("nttdata.com.approval.view.ViewSettingsDialog", this);
			...
			_onMasterMatched :  function() {
				this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
					function (mParams) {
						...
						sap.m.MessageToast.show("Test: " + " -" +  sObjectId);
						this.getRouter().navTo("object", {Vbeln : sObjectId}, true);
					}.bind(this),
					function (mParams) {
						if (mParams.error) {
							return;
